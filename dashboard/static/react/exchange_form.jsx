...
class ExchangeSettingsForm extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            exchange:'',
    ...
    handleSubmit(e) {
        ...
        const { profit_margin, stop_loss_trigger, order_cancel_seconds, min_order_size } = this.state;

        const requestOptions = {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
                profit_margin, stop_loss_trigger, order_cancel_seconds, min_order_size
            })
        };

        return fetch(`/api/exchange/settings`, requestOptions)
